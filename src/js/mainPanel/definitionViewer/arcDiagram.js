...
import transformDRS from './transformDRS'
...
export default rawData => {
    ...
    const arcDiagramDiv = document.createElement('div')
    arcDiagramDiv.setAttribute('id', 'arc-diagram')
    rViewer.appendChild(arcDiagramDiv)
    d3.select(arcDiagramDiv)
        .selectChildren()
        .remove()
